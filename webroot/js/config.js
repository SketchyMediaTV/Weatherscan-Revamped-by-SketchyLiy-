...
var apperanceSettings = {
  ...
  marqueeAd: ["Welcome, so this is my first time using WeatherTV's weatherscan service!, he gaved me the emulation so i can use it forever!, Credits to him that he made it! - rock_wx", "Remember, This emulation is NOT made completely by WeatherTV, The one who created the original was buffbears.", "If you wanna use this for yourself, Reminder to NOT use it as an app, it makes lots of malfunction, i would recomend ya use on Microsoft Edge, using Firefox and Chrome has bugs, If you wanna use this for your stream, I recommend using Browser Source on Streamlabs, OBS and others.", "WeatherTV has some amazing custom emulations, Exact like the rocktv version and sketchy version. Try it now! on https://theweathertvhome.pages.dev/"],
